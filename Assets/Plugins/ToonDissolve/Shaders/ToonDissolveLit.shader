...
void surf (Input IN, inout SurfaceOutput o) {
	...
	if (n.r - (_DisLineWidth +0.1) < _DisAmount) { //if the noise value minus the width of the line is lower than the dissolve amount
		c = _DisLineColorEx;
		o.Emission = c.rgb;// that part is the dissolve line color
	}
