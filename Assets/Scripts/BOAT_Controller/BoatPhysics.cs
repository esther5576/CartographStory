...
using UnityEngine;
    ...
    void AddUnderWaterForces()
    {
        ...
        float boatMass = /*VisbyData.mass*/ 800; //Replace this line with your boat's total mass
    ...
    void AddAboveWaterForces()
    {
        ...
        for (int i = 0; i < aboveWaterTriangleData.Count; i++)
        {
            ...
            forceToAdd += BoatPhysicsMath.AirResistanceForce(rhoAir, triangleData, /*VisbyData.C_r*/ 0.5f);
